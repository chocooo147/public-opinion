...
'''
    ...
    replacements = {
        ...
        "当前为演示面板": "当前数据说明",
        "页面已按周一至周日的7天区间设计。接入模型输出后，可自动更新周报、主题链和情感结果。": "W25—W30为完整自然周；W31为开放周。B站与小黑盒均为有限真实样本，综合视图中的观察量单位不可比。",
        ...
        "This page uses demo data. BERTopic should output topic_id, topic_name, topic_embedding, keywords, representative posts, and cross-week matches.": "W25-W30 are complete natural weeks; W31 is open. Bilibili and Heybox are bounded real samples with incomparable observation units.",
