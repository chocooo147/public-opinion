...
DOWNLOAD_GRID = """    <div class="download-grid">
      ...
      <article class="download-card">
        ...
        <p>下载 W25—W29 综合看板数据、网站“综合”页面原样长图，以及唯一的数据口径与叙述规则说明。</p>
        <div class="download-actions">
          <button class="btn primary" id="downloadFullDashboard" type="button">下载综合看板数据 .json</button>
          <a class="btn" id="downloadDashboardLongCapture" href="reports/APEX_W29_Combined_Dashboard_Long_Capture.png" download>下载综合看板完整长图 .png</a>
...
TRANSLATION_REPLACEMENTS = {
    ...
    "['下载 W25—W29 完整看板数据，或配套叙述规则，用于数据复核与后续报告生成。','Download the complete W25–W28 dashboard data or the companion narrative rules for review and later report generation.'],": "['下载 W25—W29 综合看板数据、网站“综合”页面原样长图与连续分页 PDF，以及唯一的数据口径与叙述规则说明。','Download W25–W29 combined dashboard data, a full-length capture of the Combined webpage, its sequential landscape PDF, and the single data-and-narrative guide.'],",
    "['下载 W25—W29 综合看板数据、横版分页 PDF，以及唯一的数据口径与叙述规则说明。','Download W25–W29 combined dashboard data, the paginated landscape PDF, and the single data-and-narrative guide.'],": "['下载 W25—W29 综合看板数据、网站“综合”页面原样长图与连续分页 PDF，以及唯一的数据口径与叙述规则说明。','Download W25–W29 combined dashboard data, a full-length capture of the Combined webpage, its sequential landscape PDF, and the single data-and-narrative guide.'],",
    "['下载 W25—W29 综合看板数据、网站“综合”页面原样长图与连续分页 PDF，以及唯一的数据口径与叙述规则说明。','Download W25–W29 combined dashboard data, a full-length capture of the Combined webpage, its sequential landscape PDF, and the single data-and-narrative guide.'],": "['下载 W25—W29 综合看板数据、网站“综合”页面原样长图，以及唯一的数据口径与叙述规则说明。','Download W25–W29 combined dashboard data, a full-length capture of the Combined webpage, and the single data-and-narrative guide.'],",
}
...
def optimize_html(source: str) -> str:
    ...
    source = source.replace(
        ...
        "下载内容仅覆盖中国地区。W29 样本周报仅提供 Excel；综合看板按网站“综合”页面原样捕获，仅提供完整 PNG 长图，不重新组织内容。",
    )
    source = source.replace(
    ...
    source = source.replace(
        "下载内容仅覆盖中国地区。W29 样本周报仅提供 Excel；综合看板按网站“综合”页面原样捕获，提供完整长图与连续分页 PDF，不重新组织内容。",
        "下载内容仅覆盖中国地区。W29 样本周报仅提供 Excel；综合看板按网站“综合”页面原样捕获，仅提供完整 PNG 长图，不重新组织内容。",
    )
    source = source.replace(
        ...
        "Downloads cover China only. The W29 sample weekly report is Excel-only; the Combined webpage is captured as-is and provided only as a full-length PNG without restructuring.",
    )
    source = source.replace(
    ...
    source = source.replace(
        "Downloads cover China only. The W29 sample weekly report is Excel-only; the Combined webpage is captured as-is and provided as both a full-length image and a sequential landscape PDF without restructuring.",
        "Downloads cover China only. The W29 sample weekly report is Excel-only; the Combined webpage is captured as-is and provided only as a full-length PNG without restructuring.",
    )
    ...
    source = source.replace(
        ...
        "download_paths:{dashboard_long_capture:'reports/APEX_W29_Combined_Dashboard_Long_Capture.png',data_and_narrative_guide:'templates/APEX_Dashboard_Data_and_Narrative_Guide.md'}",
    )
    source = source.replace(
    ...
    source = source.replace(
        "download_paths:{dashboard_long_capture:'reports/APEX_W29_Combined_Dashboard_Long_Capture.png',dashboard_pdf:'reports/APEX_W29_Combined_Dashboard_Landscape.pdf',data_and_narrative_guide:'templates/APEX_Dashboard_Data_and_Narrative_Guide.md'}",
        "download_paths:{dashboard_long_capture:'reports/APEX_W29_Combined_Dashboard_Long_Capture.png',data_and_narrative_guide:'templates/APEX_Dashboard_Data_and_Narrative_Guide.md'}",
    )
    ...
    forbidden = {
        ...
        "PDF download id": "downloadDashboardPdf",
        "PDF artifact": "APEX_W29_Combined_Dashboard_Landscape.pdf",
    }
