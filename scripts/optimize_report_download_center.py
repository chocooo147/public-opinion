...
DOWNLOAD_GRID = """    <div class="download-grid">
      ...
      <article class="download-card">
        ...
        <p>下载 W25—W29 综合看板数据、网站“综合”页面原样长图与连续分页 PDF，以及唯一的数据口径与叙述规则说明。</p>
        <div class="download-actions">
          ...
          <a class="btn" id="downloadDashboardPdf" href="reports/APEX_W29_Combined_Dashboard_Landscape.pdf" download>下载综合看板分页 PDF</a>
