...
- “报告预览”位于“报告下载中心”正上方，展示当前周单页中英对照内容；只读账号可预览但不显示 Excel 下载按钮；
...
- `python3 scripts/build_weekly_report_preview.py` 已从当前周 Excel 重新生成预览 JSON，预览中的周次、摘要、驱动因素数量和叙述与工作簿一致；
